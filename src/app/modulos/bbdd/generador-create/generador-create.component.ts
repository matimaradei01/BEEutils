...
import { ModalClavesGeneradasComponent } from '../../modal-claves-generadas/modal-claves-generadas.component';
...
export class GeneradorCreateComponent implements OnInit {
  ...
  generarClaves(): void {
    ...
    dialogConfig.data = {
      ...
      'contador' : this.constraintsCargadas.length
    };
    ...
    dialogRef.componentInstance.guardar.subscribe( data => {
  ...
  verClaves(): void {
    ...
    dialogConfig.data = {
      'constraint' : this.constraintsCargadas,      
    };

    dialogConfig.minWidth = '50vw';
    dialogConfig.disableClose = true;

    const dialogRef = this.dialog.open ( ModalClavesGeneradasComponent, dialogConfig );

    dialogRef.afterClosed().subscribe( data => {
      if (data != undefined) {
        let claves = data.claves;
        this.constraintsCargadas = claves;
      }             
    });
  }
